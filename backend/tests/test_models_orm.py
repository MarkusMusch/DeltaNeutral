...
from backend.models.models_orm import Base, Coin, FundingRate, InterestRate, OpenInterest, Symbol
...
class TestFundingRateORMModel:
    ...
    def test_funding_rate_insert(self, session):
        ...
        assert queried_obj.funding_rate_timestamp == datetime.utcfromtimestamp(1700000000)
    ...
    def test_funding_rate_timestamp_conversion(self, session):
        ...
        expected_datetime = datetime.utcfromtimestamp(1700000000)
...
class TestOpenInterestORMModel:
    ...
    def test_open_interest_insert(self, session):
        ...
        assert queried_obj.open_interest_timestamp == datetime.utcfromtimestamp(1700000000)
...
class TestInterestRateORMModel:
    ...
    def test_interest_rate_insert(self, session):
        ...
        assert queried_obj.interest_rate_timestamp == datetime.utcfromtimestamp(1700000000)
