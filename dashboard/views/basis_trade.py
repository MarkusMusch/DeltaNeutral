...
from db.crud.crud_interest import read_interest_entries
from db.models.models_orm import Coin, Symbol
from dashboard.utils.styling import create_dark_mode_layout


class PageInfoBasisTrade(str, Enum):
    NAV_LINK = 'Basis Trade'
    HREF = '/basis_trade'


page_layout_basistrade = html.Div(
    children=[
        dcc.Tabs(
            id="page-two-tabs",
            value='tab-1',
        ...
        html.Div(id='page-two-tabs-content')
    ],
    style={"maxWidth": "1200px", "margin": "auto", "paddingTop": "50px"}
)


def register_basistrade_callbacks(app):
    @app.callback(
        Output('page-two-tabs-content', 'children'),
        Input('page-two-tabs', 'value')
    )
