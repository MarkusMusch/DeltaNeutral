from dash import callback, html, Input, no_update, Output, State
...
def handle_tab_switch_basis_trade(_, coin, data):
    """ 
...
def update_basis_trade_carousel_slide_2(_, coin):
    """
