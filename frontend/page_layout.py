...
from frontend.views.basis_trade import PageInfoBasisTrade, page_layout_basistrade
from frontend.views.basis_trade_leveraged import PageInfoBasisTradeLeveraged, page_layout_basistrade_leveraged
from frontend.views.ethbtcusdt import PageInfoETHBTCUSDT, page_layout_ethbtcusdt
from frontend.views.short import PageInfoShort, page_layout_short
