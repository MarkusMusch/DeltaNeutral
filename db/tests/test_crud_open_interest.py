...
from db.crud.crud_open_interest import create_open_interest_entries, read_open_interest_entries, read_most_recent_update_open_interest
...
def test_create_open_interest_entries():
    ...
    with patch("db.crud.crud_open_interest.Session") as mock_session:
